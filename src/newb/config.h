...
#define NL_EXPOSURE 1.42              // [toggle] 0.5 dark ~ 3.0 bright
...
/* Water */
#define NL_WATER_TRANSPARENCY 0.74 // 0.0 transparent ~ 1.0 normal
...
#define NL_CAUSTIC_INTENSITY 4.5             // 0.5 weak ~ 5.0 bright
...
#define NL_UNDERWATER_TINT vec3(0.0,0.2,0.7) // fog tint color when underwater

/* Cloud type */
#define NL_CLOUD_TYPE 1 // 0:vanilla, 1:soft, 2:rounded

/* Vanilla cloud settings - make sure to remove clouds.png when using this */
#define NL_CLOUD0_THICKNESS 3.1      // 0.5 slim ~ 8.0 fat
#define NL_CLOUD0_RAIN_THICKNESS 5.0 // 0.5 slim ~ 8.0 fat
#define NL_CLOUD0_OPACITY 3.9        // 0.0 invisible ~ 1.0 opaque
...
*/
  ...
  #define NL_NIGHT_BRIGHTNESS -0.25
...
#ifdef CHUNK_LOAD_ANIM
  #define NL_CHUNK_LOAD_ANIM
#endif
